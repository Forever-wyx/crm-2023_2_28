...
<script type="text/javascript">
	...
	$(function(){
		...
		//点击模态窗口中的保存按钮
		$("#create-saveCustomer").click(function () {
			//获取参数
			...
			//表单验证
			//名称不能为空,这里可以在input标签中加上required属性
			if (name == ""){
				alert("名称不能为空");
				return;
			}
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="create-saveCustomer" class="btn btn-primary" data-dismiss="modal">保存</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/customer/toDetail.do?id=0229cddb32454894a81c0f4f55582e93';">动力节点</a></td>
							<td>zhangsan</td>
							<td>010-84846003</td>
