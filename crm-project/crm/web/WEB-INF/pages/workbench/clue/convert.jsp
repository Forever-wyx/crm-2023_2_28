...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivityBtn").keyup(function () {
			...
			let clueId = '${clue.id}';
			$.ajax({
				url: 'workbench/clue/searchActivityForCovertByNameClueId.do',
				data: {
				...
				success:function (data) {
					...
					$.each(data,function () {
					    htmlStr += "<tr>"
					    htmlStr += "<td><input activityName='"+this.name+"' type=\"radio\" value='"+ this.id +"' name=\"activity\"/></td>"
		...
		$("#saveConvertClueBtn").click(function () {
			...
			let isCreateTransaction = $("#isCreateTransaction").prop("checked");
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchA" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
