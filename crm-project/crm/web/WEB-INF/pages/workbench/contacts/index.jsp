...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#create-customerName").typeahead({
			source: function (jquery,process) {	//每次键盘弹起，都会自动触发本函数，向后台发送请求，
				// 查询客户表中所有的名称，以[]的格式返回到前台，赋值给source
				$.ajax({
					url: "workbench/customer/queryAllCustomerName.do",
					data: {
						name: jquery
					},
					type: "get",
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<label for="create-clueSource" class="col-sm-2 control-label">来源<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							...
							<label for="create-call" class="col-sm-2 control-label">称呼<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
			...
			<div style="position: relative;top: 20px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/customer/toDetail.do?id=0229cddb32454894a81c0f4f55582e93';">李四</a></td>
							<td>动力节点</td>
							<td>zhangsan</td>
							<td>广告</td>
							<td>2000-10-10</td>
