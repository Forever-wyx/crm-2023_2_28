	...
	<script type="text/javascript">
		$(function () {
			...
			$("#create-transactionStage").change(function () {
				...
				$.ajax({
					url: "workbench/transaction/possibilityByStageName.do",
					data: {
						name: name
					},
					type: "get",
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" value="7e8a2e06a15f451abde72ed30a37cc24" id="create-activityId">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" value="12158480d8684cc3b6055712be517149" id="create-contactsId">
